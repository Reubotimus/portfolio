    ...
    <div>
      <div className="navbar bg-base-100">
        <div className="navbar-start">
          <Link href='/'><h1 className='text-base md:text-xl lg:text-xl font-mono hover:text-teal-600 '>Harris Perdis</h1></Link>
        </div>
        <div className="navbar-end">
          ...
          <div className="dropdown dropdown-end pl-5">
            <label tabIndex={0} className="lg:hidden hover:text-teal-600 cursor-pointer">
